...
const produtosModel = require('./src/models/produtos')
const produtosController = require ('./src/controllers/podutos')
...
app.post('/produtos', async (req, res) => {
    ...
    if (nome.length > 100) {
        return res.status(400).send('Nome pode ter no máximo 100 catacteres')
    }
